...
The first step is to have [Netlify](https://www.netlify.com) and [Namecheap](https://www.namecheap.com) accounts setup.

Once that has been done, go ahead and purchase your domain on [Namecheap](https://www.namecheap.com) and also deploy your application to [Netlify](https://www.netlify.com).
...
After adding the domain, click on the 3dots to the right of the domain you just added, and select `Set Up Netlify DNS`. See example in the image below
