...
---
In this article, I would be showing how to connect a Namecheap domain to Netlify
...
> If you've not done the above yet, please take the time to do them before continue reading this article.
...
Then navigate to your application on Netlify. Click on Domain Settings

![Domain Settings](./images/netlify-domain-settings.png) 

![Add custom domain](./images/netlify-add-custom-domain.png) 



- configure dns on netlify
- add dns config to namecheap
-wait for propagation
- voalla, hosting done.
- deploy


And we're done. , You would need to wait for 1–5 minutes for Netlify to propagate, after that your web page can now be accessed by the custom domain. Netlify will issue your domain free SSL certificates.
