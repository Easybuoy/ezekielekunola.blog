...
The above command would generate a react-native project using [Expo](https://docs.expo.io).
...
Drawer navigation is a slide out drawer that contains links to various screens. The Drawer navigation opens when a menu icon is clicked or when a user swipes their finger from the left edge of the app ...
