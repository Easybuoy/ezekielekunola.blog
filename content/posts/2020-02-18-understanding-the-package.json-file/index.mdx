...
The repository keyword is a json object of key/value pairs that are used to set the version control system being used to manage the application. You can specify the type of version control being used,
