...
The engines property is an object of key/value pairs that are used to denote/specify the version of the libraries and runtimes on which the application should run.
...
The repository keyword is an object of key/value pairs that are used to set the version control system being used to manage the application. You can specify the type of version control being used,
...
Throughout the course of this article, I made use of `npm` commands for showing examples of how to do perform specific tasks, if you make use of `yarn` check [here](https://classic.yarnpkg.com/en/docs/cli/) for the `yarn CLI` commands.
