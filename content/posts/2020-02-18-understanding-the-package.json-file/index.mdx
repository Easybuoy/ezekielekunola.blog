...
- **Npm or Yarn**
  ...
  > To use the yarn method, you need to have [Yarn](https://classic.yarnpkg.com/en/docs/install#mac-stable`) installed on your system.
...
In this article, we've been able to see what a `package.json` file is, how to create it and the different properties and their use case.
