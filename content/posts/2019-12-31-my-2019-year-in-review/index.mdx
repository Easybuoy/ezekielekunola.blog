...
I later learned that the example test cases did not count toward the final score results. I knew I wasn't good with Algorithms and Data Structures then but I never expected to get a 0 in a coding challenge.
...
- [Lambda School](https://lambdaschool.com): I started work as a Technical Team Lead at [Lambda School](https://lambdaschool.com) in November, and it has been quite an experience.
  I work with people from diverse backgrounds, and it has been an opportunity for me to improve my leadership and communication skills.
...
This year was my most active year on Github, I made **3,164** contributions working on personal projects, as well as open-source contributions in 2019.
...
- [Use My Tech Stuff](https://ls-umts.netlify.com): This project was built to demonstrate my understanding of React & Redux.
...
- [Multi-User Dimension Game](https://mud-mount-doom.herokuapp.com): This was a team project built with React & Python to further establish an understanding of Data Structures and Algorithms.
...
I always wondered what contributing to Open Source meant 😅 and how it was possible, well I was able to find out this year. I contributed to several open source projects this year as well as participating for the first time in the [Hacktoberfest challenge](https://hacktoberfest.digitalocean.com).
...
I was able to be part of the mentors of the [DevCTraining](https://devctraining.andela.com) program where I mentored participating learners, provided technical support, reviewed their code, and also delivered feedback to them.
...
- Traveling 🛫: I have been stuck in Nigeria all year, I was merely moving from states to states.

---

#### Shoutouts 📣

Thanks to **Johsnon, Chinedu, Chidimma, Xavier, Ebenezer** for making 2019 🔥, for encouraging, guiding, pushing, and providing me with the much crucial support. I appreciate you guys
...
- Travel: I did a little no traveling in 2019. Next year I'm looking to travel to at least 2 countries.
