...
Early this year, I read [Prosper's 2018 year review](https://medium.com/@unicodeveloper/2018-in-review-shattering-expectations-9418f2d720cc) and it inspired me to do and accomplish a lot, and is also the reason I've decided to also write my year review as well.
...
Fastforward, I took the test on Codility, I think there were 3 questions. I solved about 2 of them, with sample tests passing, only for me to see result came back and I got 0%.
...
Apparently, the Example test cases did not count toward the final score results. I knew I wasn't good with Algorithms and Data Structures then but I never realized it was that bad.
It was truly an humbling experience that just made me realize I had lots of things I still needed to learn. Since then I've taken courses on Data Structures & Algorithms, and also solved coding challenges from time to time.
...
Thanks to **Johsnon, Chinedu, Yusuf, Kells, Chidimma, Xavier(XROLE), Ebenezer, Vincent, Kelsey, Gabe, Delba** for making 2019 🔥, for encouraging, guiding, pushing, and providing me with the much crucial support. I appreciate you guys
