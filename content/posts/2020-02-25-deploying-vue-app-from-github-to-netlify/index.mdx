...
[build]
  ...
  publish="dist"
  base = "client"
  # The base directory should be the path to the Vue project 
```
...
Once added, push the changes to Github. Netlify should automatically deploy the changes, if not, deploy the changes manually. Once deployed, your application should no longer throw errors. See the example below.
