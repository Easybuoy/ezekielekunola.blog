...
In this article, we'll be covering the different types of navigations and also how to combine the different navigations together using react navigation 5.

<!-- This has been made relatively easy since each -->
<!-- - Talk about how easy it is to do compared to other versions of react navigation -->
...
### **React Native Setup** <a name="react-native-setup"></a>

Setup a react native project, you can also make use of expo cli to setup your react native project
...
These dependencies below are the dependency relied upon for gestures, animations, transitions and ...
...
Remember in our **src/screens/Home.js** file, we had a button that did nothing, but since we have our stack navigation setup, we can now have access to navigation prop injected by the stack navigation which can help us perform many operations, one of which is redirecting.

So navigate to **src/screens/Home.js** and add the code below.
...
In order to create a drawer navigation, we would create another file in our **navigations** directory called **DrawerNavigator.js**
...
In this article, we've been able to look at a basic navigation setup for react native apps using react navigation 5. We were also able to combine the different types of navigtions together.
