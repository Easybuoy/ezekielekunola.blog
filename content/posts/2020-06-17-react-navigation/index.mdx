...
1. Create a fresh react-native project (In this section, you can say the project can be created with expo or cli. Both work.)
2. Installing Dependencies
3. Setup screens
4. Combine screens in a Stack Navigator
5. Placing a Stack Navigator inside a Tab navigator
6. Placing Stack and Tab Navigators inside a Drawer navigator
